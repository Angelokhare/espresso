    ...
    <div className="app-wrapper">
            ...
            >
              <div className="card-inner">
                <div className="card-front">
                  <img src="/images/frontPicture.png" alt="card front" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: 12 }} />
                </div>
        ...
        <div className="fail-popup" onClick={handleFailPopupClose}>
          <div className="fail-content" onClick={e => e.stopPropagation()}>
            ...
            <p
              ...
              style={{ color: '#1d152c', cursor: 'pointer', textDecoration: 'underline', fontWeight: '800'}}
            >
      ...
      <footer className="footer">
        ...
        <a 
            ...
            href="https://x.com/snicholasxiv" target="_blank" rel="noopener noreferrer">
              @Bandz (✧ᴗ✧)
        </a>
      </footer>
    </div>
